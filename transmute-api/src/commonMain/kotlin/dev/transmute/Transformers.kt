...
object ImageTransforms {
    ...
    fun opacity(
        @Param("Opacity (0.0 = fully transparent, 1.0 = unchanged)", required = true, min = "0.0", max = "1.0") opacity: Float,
...
object AudioTransforms {
    ...
    fun normalize(
        @Param("Target peak level (0.0 to 1.0)", default = "0.95", min = "0.0", max = "1.0") targetPeak: Float = 0.95f,
    ...
    fun resample(
        @Param("Target sample rate in Hz (e.g. 44100, 48000)", required = true) targetSampleRate: Int,
    ...
    fun silenceTrim(
        @Param("Silence threshold in dB (below this is considered silence)", default = "-40.0", min = "-80", max = "0") thresholdDb: Float = -40f,
    ...
    fun compressor(
        @Param("Compression threshold in dB (signal above this is compressed)", default = "-20.0", min = "-80", max = "0") thresholdDb: Float = -20f,
...
object VideoTransforms {
    ...
    fun frameRate(
        @Param("Target frames per second", required = true, min = "1", max = "240") targetFps: Double,
