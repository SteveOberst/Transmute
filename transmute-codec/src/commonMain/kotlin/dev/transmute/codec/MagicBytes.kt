...
object MagicBytes {
     ...
     */
    fun isIsoBmff(data: ByteArray): Boolean =
        data.size >= 12 &&
            data[4] == 0x66.toByte() && // 'f'
            data[5] == 0x74.toByte() && // 't'
            data[6] == 0x79.toByte() && // 'y'
     ...
     */
    fun isRiff(data: ByteArray): Boolean =
        data.size >= 12 &&
     ...
     */
    fun isEbml(data: ByteArray): Boolean =
        data.size >= 4 &&
            data[0] == 0x1A.toByte() &&
            data[1] == 0x45.toByte() &&
            data[2] == 0xDF.toByte() &&
    ...
    fun isOgg(data: ByteArray): Boolean =
        data.size >= 4 &&
            data[0] == 0x4F.toByte() && // 'O'
            data[1] == 0x67.toByte() && // 'g'
            data[2] == 0x67.toByte() && // 'g'
