 ...
 */
class ContentFidelityIntegrationTest : GStreamerTestBase() {
  ...
  private suspend fun assertDurationWithin(codec: dev.transmute.audio.AudioCodec, format: AudioFormat, inputMs: Long, toleranceMs: Long) {
  ...
  private suspend fun assertVideoDimensions(codec: dev.transmute.video.VideoCodec, format: VideoFormat, width: Int, height: Int) {
