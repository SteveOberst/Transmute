...
value class MediaDomain(val mask: Int) {
    ...
    operator fun contains(other: MediaDomain): Boolean =
        mask and other.mask == other.mask

    /** Combine two domain masks. */
    infix fun or(other: MediaDomain): MediaDomain =
        MediaDomain(mask or other.mask)

    /** Intersect two domain masks. */
    infix fun and(other: MediaDomain): MediaDomain =
        MediaDomain(mask and other.mask)

    /** Remove [other]'s flags from this mask. */
    operator fun minus(other: MediaDomain): MediaDomain =
        MediaDomain(mask and other.mask.inv())
