...
import dev.transmute.model.structure.image.JpegStructure
import dev.transmute.model.structure.image.toStructure

/** Decodes raw bytes into a [JpegStructure]. */
class JpegStructureDecoder : Decoder<ImageFormat, JpegStructure, NoDecodeOptions> {
    private val rawDecoder = JpegRawDecoder()
    ...
    override suspend fun decode(source: Bytes, options: NoDecodeOptions, context: PipelineContext): JpegStructure =
