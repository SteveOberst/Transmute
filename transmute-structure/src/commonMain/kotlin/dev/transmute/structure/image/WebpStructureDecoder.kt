...
import dev.transmute.model.structure.image.WebpStructure
import dev.transmute.model.structure.image.toStructure

/** Decodes raw bytes into a [WebpStructure]. */
class WebpStructureDecoder : Decoder<ImageFormat, WebpStructure, NoDecodeOptions> {
    private val rawDecoder = WebpRawDecoder()
    ...
    override suspend fun decode(source: Bytes, options: NoDecodeOptions, context: PipelineContext): WebpStructure =
