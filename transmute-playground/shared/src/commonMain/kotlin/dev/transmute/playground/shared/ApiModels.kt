 ...
 */
@Serializable
data class ProgressEvent(val jobId: String, val stage: String, val progress: Float, val message: String? = null)
 ...
 */
@Serializable
data class WaveformData(val samples: List<Float>, val sampleRate: Int, val channels: Int, val durationMs: Long)
