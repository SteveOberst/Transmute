 ...
 */
class ExtendedFormatCodecIntegrationTest {

  private val decoder = JvmImageIoDecoder()
  private val encoder = JvmImageIoEncoder()
  private val ctx = testContext()

  private suspend fun encodeGif(ir: ImageIR): Bytes = encoder.encode(ir, ImageFormat.Gif, CanonicalImageEncodeOptions(), ctx)

  private suspend fun encodeTiff(ir: ImageIR): Bytes = encoder.encode(ir, ImageFormat.Tiff, CanonicalImageEncodeOptions(), ctx)
