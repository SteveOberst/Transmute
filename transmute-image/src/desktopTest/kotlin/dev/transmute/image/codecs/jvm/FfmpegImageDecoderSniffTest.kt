...
class FfmpegImageDecoderSniffTest {
  ...
  fun sniffHeic() {
    ...
    assertEquals(ImageFormat.HEIC, decoder.sniff(data))
  }
  ...
  fun sniffHeifMif1() {
    ...
    assertEquals(ImageFormat.HEIF, decoder.sniff(data))
  }
  ...
  fun sniffAvif() {
    ...
    assertEquals(ImageFormat.AVIF, decoder.sniff(data))
  }
  ...
  fun sniffRejectsTooShort() {
    assertNull(decoder.sniff(ByteArray(8)))
