 ...
 */
open class TransmuteModelException(message: String, cause: Throwable? = null) : RuntimeException(message, cause)
 ...
 */
class InvalidNumericValueException(message: String, cause: Throwable? = null) : TransmuteModelException(message, cause)
 ...
 */
class InvalidStringEncodingException(message: String, cause: Throwable? = null) : TransmuteModelException(message, cause)

/**
 * Thrown when a byte offset, length, or range is logically invalid
 * (e.g. negative offset, zero-length range, end before start).
 */
class InvalidByteRangeException(message: String, cause: Throwable? = null) : TransmuteModelException(message, cause)

/**
 * Thrown when a container-level identifier value is out of its allowed
 * range (e.g. [FourCC] byte outside 0x00-0xFF).
 */
class InvalidIdentifierException(message: String, cause: Throwable? = null) : TransmuteModelException(message, cause)
