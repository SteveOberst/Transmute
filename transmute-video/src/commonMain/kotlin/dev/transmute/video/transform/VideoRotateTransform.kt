 ...
 */
class VideoRotateTransform(val degrees: Int) : VideoTransform {
 ...
 */
private class RotatedFrameStream(private val source: FrameStream, private val degrees: Int) : FrameStream {
