...
class VideoCodecAdapter(private val decoder: VideoDecoder, private val encoder: VideoEncoder) : VideoCodec {
...
class VideoDecoderCodecAdapter(private val decoder: VideoDecoder) :
...
class VideoEncoderCodecAdapter(private val encoder: VideoEncoder) :
  MediaCodec<VideoFormat, VideoIR, VideoDecodeOptions, VideoEncodeOptions> {
  override val encodableFormats: Set<VideoFormat> get() = encoder.supportedFormats
